...
#print(archivo.stat()) # Imprime información del archivo
...
print("Creacion:", ctime(archivo.stat().st_ctime)) # Tiempo de creación
print("MOdificacion:", ctime(archivo.stat().st_mtime)) # Tiempo de última modificación